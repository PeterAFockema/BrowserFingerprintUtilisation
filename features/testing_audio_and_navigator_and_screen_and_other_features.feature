Feature: Checking audio and navigator and screen and other feature element fingerprinting responses      
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator and screen and webgl value
        ...
        # Then the Firefox audio and navigator and screen value has been recorded
        ...
        # Then the Firefox audio and navigator and screen value is saved
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator and screen and webRTC value
