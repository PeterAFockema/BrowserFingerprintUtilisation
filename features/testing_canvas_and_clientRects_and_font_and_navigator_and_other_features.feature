Feature: Checking canvas and clientRects and font and navigator and other feature element fingerprinting responses   
    Scenario: Preliminary Firefox test results for an extension to change the canvas and clientRects and font and navigator and screen value
        ...
        Then the Firefox canvas and clientRects and font and navigator value has been recorded
        ...
        Then the Firefox canvas and clientRects and font and navigator value is saved
    ...
    Scenario: Preliminary Firefox test results for an extension to change the canvas and clientRects and font and navigator and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the canvas and clientRects and font and navigator and webRTC value
