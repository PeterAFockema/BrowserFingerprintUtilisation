Feature: Checking audio and clientRects and other feature element fingerprinting responses
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects and font value
        ...
        Then the Firefox audio and clientRects value has been recorded
        ...
        Then the Firefox audio and clientRects value is saved
        Then the Firefox font value is saved
        Then the visitor id for audio and clientRects and font is saved
    
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects and navigator value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects and webRTC value
        ...
        Then we will log the audio and clientRects and webRTC testing time in the saved file
        Then the Firefox audio and clientRects value is saved
