...
canvas_and_clientRects_and_navigator_increment = 0
...
def we_view_the_firefox_page_with_some_canvas_and_clientRects_and_navigator_and_screen_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension_list(["canvas", "clientRects", "navigator",  "screen"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 

@when('we view the Firefox page with some canvas and clientRects and navigator and webgl values interference')
def we_view_the_firefox_page_with_some_canvas_and_clientRects_and_navigator_and_webgl_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension_list(["canvas", "clientRects", "navigator",  "webgl"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 

@when('we view the Firefox page with some canvas and clientRects and navigator and webRTC values interference')
def we_view_the_firefox_page_with_some_canvas_and_clientRects_and_navigator_and_webRTC_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension_list(["canvas", "clientRects", "navigator",  "webRTC"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 
...
def we_have_a_firefox_page_which_ran_the_canvas_and_clientRects_and_navigator_and_other_features_response(context):
    assert test_manager.html_puller_firefox.html_source != "<html></html>"
...
@then('we will log the canvas_and_clientRects and navigator and webRTC testing time in the saved file')
...
@then('the visitor id for canvas and clientRects and navigator and screen is saved')
@then('the visitor id for canvas and clientRects and navigator and webgl is saved')
@then('the visitor id for canvas and clientRects and navigator and webRTC is saved')
def the_firefox_visitor_id_for_canvas_and_clientRects_and_navigator_and_other_features_has_been_recorded(context):
