...
def we_view_the_firefox_page_with_some_battery_and_clientRects_and_font_and_webRTC_values_interference(context):
    ...
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension_list(["battery", "clientRects", "font", "webgl", "webRTC"]), "html.parser").find())
...
@then('we will log the battery_and_clientRects and font and webgl and webRTC testing time in the saved file')
