...
battery_and_clientRects_and_font_and_webgl_increment = 0
...
def we_view_the_firefox_page_with_some_battery_and_clientRects_and_font_and_webRTC_values_interference(context):
    ...
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["battery", "clientRects", "font", "webgl", "webRTC"]), "html.parser").find())
