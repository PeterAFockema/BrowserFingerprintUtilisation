...
# audio_and_clientRects_and_webgl_increment = 0
...
def we_view_the_firefox_page_with_some_audio_and_clientRects_and_webgl_and_webRTC_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension_list(["audio", "clientRects", "webgl",  "webRTC"]), "html.parser").find())
