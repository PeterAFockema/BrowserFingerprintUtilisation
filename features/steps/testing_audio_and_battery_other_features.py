...
audio_and_battery_increment = 0

'''
The following definitions relate to the Firefox browser.
'''

@when('we view the Firefox page with some audio and battery and canvas values interference')
def we_view_the_firefox_page_with_some_audio_and_battery_and_canvas_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "canvas"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 

@when('we view the Firefox page with some audio and battery and clientRects values interference')
def we_view_the_firefox_page_with_some_audio_and_battery_and_clientRects_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "clientRects"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 

@when('we view the Firefox page with some audio and battery and font values interference')
def we_view_the_firefox_page_with_some_audio_and_battery_and_font_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "font"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 
...
def we_view_the_firefox_page_with_some_audio_and_battery_and_navigator_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "navigator"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 
...
def we_view_the_firefox_page_with_some_audio_and_battery_and_screen_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "screen"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 
...
def we_view_the_firefox_page_with_some_audio_and_battery_and_webgl_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "webgl"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 
...
def we_view_the_firefox_page_with_some_audio_and_battery_and_webRTC_values_interference(context):
    html_puller_firefox = test_manager.html_puller_firefox
    bool(BeautifulSoup(html_puller_firefox.pull_HTML_page_with_extension(["audio", "battery", "webRTC"]), "html.parser").find())
    assert test_manager.html_puller_firefox.html_source != "<html></html>" 

@then('we have a Firefox page which ran the audio and battery and canvas response')
@then('we have a Firefox page which ran the audio and battery and clientRects response')
@then('we have a Firefox page which ran the audio and battery and font response')
@then('we have a Firefox page which ran the audio and battery and navigator response')
@then('we have a Firefox page which ran the audio and battery and screen response')
@then('we have a Firefox page which ran the audio and battery and webgl response')
@then('we have a Firefox page which ran the audio and battery and webRTC response')
def we_have_a_firefox_page_which_ran_the_audio_and_battery_and_other_features_response(context):
    assert test_manager.html_puller_firefox.html_source != "<html></html>"
...
@then('the visitor id for audio and battery and battery is saved')
