...
# @when('we view the Firefox page with some audio and battery and canvas and font and {last_item} values interference')
...
#     extensions = ["audio", "battery", "canvas", "font", extension_name]
