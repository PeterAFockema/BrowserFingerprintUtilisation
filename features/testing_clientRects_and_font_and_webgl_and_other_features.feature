Feature: Checking clientRects and font and webgl and other feature element fingerprinting responses   
    Scenario: Preliminary Firefox test results for an extension to change the clientRects and font and webgl and webRTC value
        ...
        Then the Firefox clientRects and font and webgl value has been recorded
        ...
        # Then the Firefox clientRects and font and webgl value is saved
        ...
        Then the visitor id for clientRects and font and webgl and webRTC is saved