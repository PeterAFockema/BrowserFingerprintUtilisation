Feature: Checking font and other feature element fingerprinting responses    
    Scenario: Preliminary Firefox test results for an extension to change the font and navigator value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the font and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the font and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the font and webRTC value
