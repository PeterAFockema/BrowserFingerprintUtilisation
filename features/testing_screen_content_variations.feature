Feature: Checking HTMLElement avail variations for effects on fingerprinting responses
    Scenario: Preliminary Firefox test results for no extension to change HTMLElement avail values
    ...
    Scenario: Preliminary Firefox test results for an extension to change the Prototype availHeight value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the Prototype availWidth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the Prototype colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the Prototype devicePixelRatio value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype availHeight and availWidth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype availHeight and colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype availHeight and devicePixelRatio value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype availWidth and colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype availWidth and devicePixelRatio value
    ...
    Scenario: Preliminary Firefox test results for an extension to change both Prototype colorDepth and devicePixelRatio value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the three Prototype availHeight and availWidth and colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the three Prototype availHeight and availWidth and devicePixelRatio value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the three Prototype availHeight and devicePixelRatio and colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the three Prototype availWidth and devicePixelRatio and colorDepth value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the four Prototype availHeight and availWidth and devicePixelRatio and colorDepth value
