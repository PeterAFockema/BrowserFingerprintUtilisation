Feature: Checking canvas and font and screen element fingerprinting responses
    ...
    #Scenario: Preliminary Firefox test results for no extension to change the canvas and font value
