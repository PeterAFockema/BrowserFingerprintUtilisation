Feature: Checking battery and clientRects and navigator and other feature element fingerprinting responses       
    Scenario: Preliminary Firefox test results for an extension to change the battery and clientRects and navigator and screen value
        When we view the Firefox page with some battery and clientRects and navigator and screen values interference
        Then we have a Firefox page which ran the battery and clientRects and navigator and screen response
        Then the Firefox battery and clientRects and navigator value has been recorded
        ...
        # Then the Firefox battery and clientRects and navigator value is saved
    ...
    Scenario: Preliminary Firefox test results for an extension to change the battery and clientRects and navigator and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the battery and clientRects and navigator and webRTC value
