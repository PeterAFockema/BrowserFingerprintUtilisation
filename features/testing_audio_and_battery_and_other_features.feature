Feature: Checking audio and battery and other feature element fingerprinting responses
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and canvas value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and clientRects value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and font value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and navigator value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and webRTC value
