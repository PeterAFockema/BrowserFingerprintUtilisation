Feature: Checking battery and canvas and font and other feature element fingerprinting responses   
    Scenario: Preliminary Firefox test results for an extension to change the battery and canvas and font and navigator value
        ...
        # Then the Firefox battery and canvas and font value has been recorded
        ...
        # Then the Firefox battery and canvas and font value is saved
    ...
    Scenario: Preliminary Firefox test results for an extension to change the battery and canvas and font and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the battery and canvas and font and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the battery and canvas and font and webRTC value
