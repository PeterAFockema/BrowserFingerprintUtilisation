Feature: Checking font and navigator and screen and webgl and other feature element fingerprinting responses   
    Scenario: Preliminary Firefox test results for an extension to change the font and navigator and screen and webgl and webRTC value
