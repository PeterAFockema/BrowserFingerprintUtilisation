Feature: Checking audio and font and navigator and other feature element fingerprinting responses      
    Scenario: Preliminary Firefox test results for an extension to change the audio and font and navigator and screen value
        ...
        Then the Firefox audio and font and navigator value has been recorded
        ...
        Then the Firefox audio and font and navigator value is saved
        Then the Firefox screen value is saved
        Then the visitor id for audio and font and navigator and screen is saved

    Scenario: Preliminary Firefox test results for an extension to change the audio and font and navigator and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and font and navigator and webRTC value
