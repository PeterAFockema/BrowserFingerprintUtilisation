Feature: Checking battery and clientRects and webgl and other feature element fingerprinting responses       
    Scenario: Preliminary Firefox test results for an extension to change the battery and clientRects and webgl and webRTC value
