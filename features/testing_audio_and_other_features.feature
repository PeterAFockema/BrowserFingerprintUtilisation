Feature: Checking audio and other feature element fingerprinting responses
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery value
...
Scenario: Preliminary Firefox test results for an extension to change the audio and canvas value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and clientRects value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and font value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and webRTC value
