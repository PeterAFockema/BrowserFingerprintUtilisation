Feature: Checking font and navigator and screen and other feature element fingerprinting responses   
    Scenario: Preliminary Firefox test results for an extension to change the font and navigator and screen and webgl value
        ...
        # Then the Firefox font and navigator and screen value has been recorded
        ...
        # Then the Firefox font and navigator and screen value is saved
        ...
        Then the visitor id for font and navigator and screen and webgl is saved

    Scenario: Preliminary Firefox test results for an extension to change the font and navigator and screen and webRTC value
        When we view the Firefox page with some font and navigator and screen and webRTC values interference
        Then we have a Firefox page which ran the font and navigator and screen and webRTC response
        # Then the Firefox font and navigator and screen value has been recorded
        ...
        Then the visitor id for font and navigator and screen and webRTC is saved