Feature: Checking audio and battery and canvas and navigator and other feature element fingerprinting responses    
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and canvas and navigator and screen value
        ...
        # Then the Firefox audio and battery and canvas and navigator value has been recorded
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and canvas and navigator and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and battery and canvas and navigator and webRTC value
        ...
        Then the Firefox audio and battery and canvas and navigator and webRTC value is saved
