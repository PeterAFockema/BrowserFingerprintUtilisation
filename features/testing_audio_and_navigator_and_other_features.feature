Feature: Checking audio and navigator and other feature element fingerprinting responses
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator and screen value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator and webgl value
    ...
    Scenario: Preliminary Firefox test results for an extension to change the audio and navigator and webRTC value
